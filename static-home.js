...
<section class="section now">${sectionTitle('Now on Untoz')}<div class="now-grid">${cards.map((c,i)=>`<a href="#stories" class="now-card"><img src="${c[3]}" alt=""><div class="card-shade"></div><span class="tag t${i}">${c[0]}</span><div class="now-copy"><h3>${c[1]}</h3><p>${c[2]}</p></div><span class="round-arrow">›</span></a>`).join('')}</div></section>
<section class="section stories" id="stories"><div class="stories-head"><h2>Top Stories</h2><div class="filters"><button class="active">All</button><button>News</button><button>Entertainment</button><button>Sports</button><button>Gaming</button><button>Space</button></div><a href="#footer">View all →</a></div><div class="stories-grid"><a class="lead-story" href="#footer"><img src="https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1400&q=90" alt=""><div class="card-shade"></div><span class="story-tag">ENTERTAINMENT</span><div class="lead-copy"><h3>The Untoz Awards are heading to Dubai</h3><p>The next edition of the Untoz Awards will take place in Dubai, bringing together the biggest names in music, film, TV and digital entertainment.</p><b>Read more →</b></div></a><div class="story-list"><a href="#footer"><img src="https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?auto=format&fit=crop&w=700&q=85" alt=""><div><small>SPACE</small><h3>Untoz Space: looking beyond Earth</h3><p>Exploring a bigger, brighter future.</p></div></a><a href="#footer"><img src="https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=700&q=85" alt=""><div><small>SPORTS</small><h3>Live coverage, results and highlights</h3><p>All the latest from the world of sport.</p></div></a><a href="#footer"><img src="https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=700&q=85" alt=""><div><small>GAMING</small><h3>Everything from the latest gaming news</h3><p>Games, trailers and more.</p></div></a></div></div></section>
<section class="section" id="featured">${sectionTitle('Featured in Untoz+')}<div class="featured-grid">${featured.map(f=>`<a href="https://untozplus.com/" class="featured-card"><img src="${f[2]}" alt=""><b>${f[0]}</b><small>${f[1]}</small></a>`).join('')}</div></section>
...
<section class="section lower"><div class="events" id="events">${sectionTitle('Upcoming Events')}<div class="event-list"><a href="#footer"><div class="date"><b>12</b><span>AUG</span></div><div><small>Untoz+</small><strong>Untoz+ Launch</strong></div><b>›</b></a><a href="#footer"><div class="date"><b>13</b><span>AUG</span></div><div><small>Untoz</small><strong>Untoz Fest</strong></div><b>›</b></a><a href="#footer"><div class="date"><b>20</b><span>OCT</span></div><div><small>Untoz</small><strong>Untoz Anniversary</strong></div><b>›</b></a><a href="#footer"><div class="date"><b>APR</b><span>2027</span></div><div><small>Untoz</small><strong>Untoz Awards 2027</strong></div><b>›</b></a></div></div><a class="universe-card" id="universe" href="#footer"><img src="https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?auto=format&fit=crop&w=1200&q=90" alt=""><div class="card-shade"></div><div><small>THE UNTOZ UNIVERSE</small><h2>Everything Untoz,<br>in one place.</h2><p>Channels, projects, productions,<br>products and worlds.</p><span class="pill primary light">Explore the universe →</span></div><strong style="position:absolute;right:35px;top:50%;transform:translateY(-50%);z-index:2;font-size:80px;color:#04db7d">∞</strong></a><div class="videos" id="videos">${sectionTitle('Latest Videos')}<div class="video-list">${[['Untoz is now streaming','01:24'],['Inside the Untoz Awards','02:37'],['Looking beyond Earth','05:12'],['The Untoz story','04:05']].map((v,i)=>`<a href="#footer"><div class="video-thumb"><img src="${featured[(i+1)%featured.length][2]}" alt=""><span>▶</span></div><div><strong>${v[0]}</strong><small>${v[1]}</small></div><b>›</b></a>`).join('')}</div></div></section>
</main>
