...
import{Search,Moon,Sun,User,ChevronDown,ChevronRight,ChevronLeft,Play,ArrowRight,Clapperboard,Star,Balloon,Gamepad2,Music2,Orbit,Infinity}from'lucide-react';
import'./styles.css';
...
function SectionTitle({children,link='View all'}){return <div className="section-title"><h2>{children}</h2>{link&&<a href="#footer">{link} <ArrowRight size={14}/></a>}</div>}
